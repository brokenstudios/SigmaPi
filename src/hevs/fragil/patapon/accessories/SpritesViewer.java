...
public class SpritesViewer extends PortableApplication {
	...
	public void onInit() {
		...
		setTitle("SIGMAPI - 2016 - Broken Studios - Loïc Fracheboud, Loïc Gillioz, S2d - SPRITESHEET VIEWER");
	...
	public void onGraphicRender(GdxGraphics g) {
		...
		g.drawStringCentered(870, "SPRITESHEET VIEWER", Param.medium);
	}
